...
class TestGPSPhotoExtractor:
    ...
    def test_extract_metadata_with_valid_gps(self, mock_open, extractor):
        ...
        gps_info = {1: "N", 2: (40.0, 0.0, 0.0), 3: "W", 4: (3.0, 0.0, 0.0), 6: 100.0}
    ...
    def test_extract_metadata_no_gps(self, mock_open, extractor):
        ...
        # EXIF without GPS
        mock_img._getexif.return_value = {36867: "2023:01:01 12:00:00"}
    ...
    def test_extract_metadata_zero_coordinates(self, mock_open, extractor):
        ...
        gps_info = {1: "N", 2: (0.0, 0.0, 0.0), 3: "E", 4: (0.0, 0.0, 0.0), 6: 0.0}

        mock_img._getexif.return_value = {34853: gps_info}
