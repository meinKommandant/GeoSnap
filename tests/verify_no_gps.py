...
class TestNoGPSFeature(unittest.TestCase):
    ...
    def test_process_with_options(
        self, mock_executor, mock_kmz_gen, mock_excel_gen, mock_extractor_cls, mock_path, mock_as_completed
    ):
        # Setup common mocks
        ...
        meta_no_gps = PhotoMetadata(
            filename="photo_no_gps.jpg", filepath="path/to/photo_no_gps.jpg", timestamp=None, coordinates=None
        )
        ...
        result = process_photos_backend(
            str(self.input_dir), str(self.output_dir), self.project_name, include_no_gps=True
        )
        ...
        result = process_photos_backend(
            str(self.input_dir), str(self.output_dir), self.project_name, include_no_gps=False
        )
